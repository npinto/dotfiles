...
-- settings.apps.filemanager = "nautilus"
...
globalkeys = awful.util.table.join(
    ...
    -- npinto
    awful.key({ modkey, "Control", "Shift"    }, "l", function () awful.util.spawn("xtrlock") end),
    awful.key({ modkey,           }, "g", function () awful.util.spawn("chromium") end),
    awful.key({ modkey,           }, "p", function () awful.util.spawn("terminator -e ipython") end),
    awful.key({ modkey,           }, "t", function () awful.util.spawn("urxvt") end),
    awful.key({ modkey,           }, "F1", function () awful.layout.set(layouts[1]) end),
    awful.key({ modkey,           }, "F2", function () awful.layout.set(layouts[6]) end),
    awful.key({ modkey,           }, "F3", function () awful.layout.set(layouts[9]) end),
    awful.key({ modkey,           }, "F4", function () awful.layout.set(layouts[2]) end),
    awful.key({ modkey,           }, "F5", function () awful.layout.set(layouts[3]) end),
    awful.key({ modkey,           }, "F6", function () awful.layout.set(layouts[8]) end),

    awful.key({ modkey, "Shift" }, "n", function () awful.client.incwfact(-0.05) end),
    awful.key({ modkey, "Shift" }, "m", function () awful.client.incwfact( 0.05) end),
